...
("default_actions", (: call_other, __FILE__, "query_action" :));
    ...
    if( undefinedp(my["Merits"])) // 設定內在素質
    {
        my["Merits"] = ([
                    ...
                    "wit": (my["int"]+my["dex"])/40,
                    "sou": (my["int"]+my["str"])/40,
                    "tec": (my["int"]+my["dex"])/35,
                        ]);
    }
    else
    {
        ...
        if( undefinedp(my["Merits"]["wit"]))
            my["Merits"]["wit"]=(my["int"]+my["dex"])/40;
        if( undefinedp(my["Merits"]["sou"]))
            my["Merits"]["sou"]=(my["int"]+my["str"])/40;
        if( undefinedp(my["Merits"]["tec"]))
            my["Merits"]["tec"]=(my["int"]+my["con"])/35;
    }
...
void reset_attribute(object ob)
{
    ...
    if(userp(ob))
    {
        ...
        my["Merits"]["wit"]=(q_int+q_dex)/40;
        my["Merits"]["sou"]=(q_int+q_str)/40;
        my["Merits"]["tec"]=(q_int+q_con)/35;
    }
