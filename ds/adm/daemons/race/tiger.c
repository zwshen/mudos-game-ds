...
mapping *combat_action = ({
                              ...
                              ([        "action":               "$N虎吼一聲提起拳頭往$n的$l捶去",
                                 "attact_type":  "sou",
                                 "damage_type": "瘀傷",
                               ]),
                              ([        "action":               "$N虎吼一聲對準$n的$l用力揮出一拳",
                                 "attact_type":  "sou",
                                 "damage_type": "瘀傷",
                               ]),
                          });
