...
string *dodge_msg = ({
 ...
 "\n$n雙腳一蹬，直衝上天，一式"+HIC+" [ 驚 弓 之 鳥 ] "+NOR+"漂亮的落在$N身後。\n",
 "\n突然$n腳步變輕，一招"+HIM+" [ 反 樸 歸 貞 ] "+NOR+"，在$N的攻勢中遊走四方。\n",
...
int exert(object me, object target, string arg)
{
        ...
        if(me->query_skill("dodge")<20) return notify_fail("以你的輕功\基礎無法使用『靈翼八步訣』。\n");
        ...
        if(me->query("ap")<10 || me->query("hp")<10) return notify_fail("你的身體狀無法使用『靈翼八步訣』。\n");
