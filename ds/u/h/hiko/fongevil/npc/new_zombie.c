...
void create()
{
        set_name(CYN "新屍" NOR ,({"new zombie","zombie"}) );
        set("long",@LONG
新屍看來行走緩慢之樣，雙眼看來毫無生氣，動作極不靈活，身上只靠著
本能行動。新屍為殭屍王　戾絕的屍軍中剛成為殭屍的屍體，因此實戰經
驗很少，可是卻是最多的。
LONG
);
        set("age",60);
        ...
        setup();
       carry_object(__DIR__"../eq/death_cloth")->wear();       set_living_name("zombie-war-mob");
