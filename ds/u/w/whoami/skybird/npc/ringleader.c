...
LONG);
 ...
 set("gender","女性");
 set("level",45);  
 set("max_hp",12600+random(3000)); 
 set("max_ap",8000); 
 set("str",75+random(18)); 
 set("dex",95);  
 set("Merits/bar",4+random(3));  
 set("Merits/wit",3+random(3)); 
 set_temp("apply/damage",125+random(40)); 
 set_temp("apply/hit",40+random(40));
 ...
 set_skill("dodge",85+random(15)); 
 set_skill("parry",85+random(15)); 
 set_skill("block",85+random(15));  
 setup();  
