...
mapping *combat_action = ({
    ...
    ([  "action":      "$N口中喃喃自語,九重天咒
之 "+CYN+"【"+NOR+""+HIW+"滅殺訣"+NOR+""+CYN+"】"+NOR+"一道白光閃過$n的$l!",
...
LONG
 ...
 (:command("kill monk"):),
    ...
    carry_object(__DIR__"eq/maigu_gloves")->wear();
    carry_object(__DIR__"eq/maigu_leggings")->wear();
}
