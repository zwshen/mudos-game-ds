...
int do_xput(object me, object obj, object dest, int func)
{
        ...
        if( func && dest == this_object() ) {
                if( (obj->query("skill_type") || obj->is_weapon()) && objectp(tmp = load_object("/open/world1/manto/sky2_1f/map_1_11.c")) )
                {
                ...
                else if( ( obj->query("armor_type") || obj->is_armor() ) && objectp(tmp = load_object("/open/world1/manto/sky2_1f/map_3_11.c")) )
                {
                        if( tmp != environment(this_object()) )
                        {
                ...
                else if( objectp(tmp = load_object("/open/world1/manto/sky2_1f/map_5_11.c")) )
                {
                        if( tmp != environment(this_object()) )
                        {
