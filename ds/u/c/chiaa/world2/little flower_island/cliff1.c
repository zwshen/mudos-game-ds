//u/c/chiaa/world2/little flower_island/cliff1.c
...
LONG
        ...
        "northwest"   : __DIR__"champaign3",    //平原3
  ]));
    set("item_desc",([
...
int do_jump(string str)  //系統會將玩家所輸入的"touch"這個指令後的所有                             //文字以字串型別的引數傳給 do_jump()　 
