...
LONG
 ...
 set("exits",([ "in":"/open/world1/tmr/area/inn_2f",
                "east":"/u/f/faceoff/school2.c"   
    ]));
 set("item_desc",([
        "books":"你看了看這些塵封已久的書, 發現它們照著編號排列, 你想應該從第一
本(book_1)開始看起.\n",
        "sign":"這面鐵製的告示牌寫著:!! 歡迎使用新手教室 !!.\n",
        "book_1":"這二本書主要是要告訴你一些新手應該知道的常識, 首先, Ds跟其
它的mud一樣, 新手務必要先看一看我們的規則(help rules), 因為你所玩的mud可以的事
項可能Ds不可以, 所以讀規則可以避免你無形中犯錯, 看到這裡, 你應該已經知道這本書是
要教你如何使用help, 你可以在普通情況下直接鍵入help, 接下來會出現一些help主題, 你
可以打help xxxx再多知道一些詳情, 好了..這一本書教你如何用help, 就到這裡, 接下來
你就可以看第二本書(book_2)了.祝你一路順風....\n",
