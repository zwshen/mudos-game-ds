...
int do_climb(string arg)
{
        ...
        me->start_busy(2);
        me->receive_wound("right_arm", 4+random(6));
        me->receive_wound("left_arm", 4+random(6));
        me->receive_wound("right_leg", 4+random(6));
        me->receive_wound("left_leg", 4+random(6));
	me->start_busy(2);
	return 1;
}
