...
string *list = ({
        "/open/always/game_gift/six-legging.c",
        "/open/always/game_gift/six-ring.c",
...
void create()
{
        ...
        set("gender", "女性" );
        set("age", 17);
        set("long","永遠的１７歲，要跟我買巧克力的請打elist 和 ebuy吧!!\n");
        set("level",1);
        ...
        set("chat_chance",10);
        set("chat_msg", ({
                (:command,"say 別害羞喔，要買巧克力請打elist 和 ebuy喔....":),
                (:command,"smile":),
...
{       
        ...
        add_action("do_list","elist");
        add_action("do_buy","ebuy");
        }
...
int accept_object(object me,object ob)
{
        ...
        call_out( (:destruct($1):), 1, ob);
            ...
            switch(lucky)
                ...
                case 25:
                        me->add("exp", 1000000);
                        command("tchat 恭喜玩家"+me->query("name")+"("+me->query("id")+") 中了三獎，得到1000000 exp，請大家幫他恭喜一下吧！");
                        return 1;
                break;
                case 35:
                ...
                break;
                 case 40..50:
                        me->add("bank/past", 300000);
                        command("tchat 恭喜玩家"+me->query("name")+"("+me->query("id")+") 中了五獎，獲得古幣300000，請大家幫他恭喜一下吧！");
                        return 1;
                break;
