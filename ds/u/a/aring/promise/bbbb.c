...
¤å¥ó¸Ì¨S¦³»¡©ú¡M¦A´£¥XºÃ°Ý¡M§Å®vªº¥D­nÂ¾³d¨Ã¤£¬O±Ðª±®a¦p¦óª±¡C
    ¬°¤F§ùµ´¾÷¾¹¤H¡M±z¥i¥H¦b³o¸ÌÀËÁ|(accuse)¬Y­Óª±®a¡M¸Ó¦Wª±®a·|³Q§ì¥h
        ...
        if(ob->is_inactive()) return notify_fail( ob->name(1) + "¥Ø«e¥¿³B©ó¶¢¸m¼Ò¦¡¤¤¡C\n");
                ...
                if(env_file=="/d/wiz/courthouse")
                        return notify_fail(ob->name(1) + "¤w¸g¦b±µ¨ü´úÅç¤F¡C\n");
                                tell_object(ob,"¬Y¤HÀËÁ|§A¬O­Ó¾÷¾¹¤H¡M½Ð§A±µ¨ü¤@­Ó¤p¤pªº´úÅç¡C\n" NOR); 
 message("world:world1:vision",
HIG"\n[0;1;37;44m¡[1mi[1m¤[1mC[1m°[1mì[1m§[1mÖ[1m³[1mø[1m¡[1mj[0m "HIW"¬Y¤H"HIW"¬Ý¤£ºD"HIB+ ob->name(1)+HIW"ªº©ñ¾÷©MºA«×µ¥µ¥ªº§@­·¡A¦b¦¹®É³Q§ì¥h¼f§PÆU¼f°Ý¤F¡I¡I
\n\n"NOR,users());
