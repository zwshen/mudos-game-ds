...
void create()
{
 ...
 set_skill("dodge",50);
 set("chat_chance",20);
 set("chat_msg", ({"王轑拿起手中的狐皮帽嘆了一口氣.\n",
                   (:command("sigh"):),
 }));
set("chat_chance_combat",100);
 set("talk_reply","你能幫老夫一點忙(help)嗎?\n");
 set("inquiry/help","你若能找到傳說中的狐皮, 我便織一頂帽子給你.\n");
 set("chat_msg_combat",({                         
                         (:command,"say 你太小看我了!!":),
 }));
 setup();
...
void givehat()
{
      ...
      switch( i ) {
          ...
          case 3:
            ...
            break;
          case 4:
say(HIY"過了一會王轑手上便多了一頂帽子。\n"NOR);
            obj->set_temp("givehat",i+1);
            call_out("givehat",3,me);
            break;
          case 5:
            command("say 老夫把那張狐皮的一部分做了一頂帽子, 便送給你當酬勞吧");
            obj->set_temp("givehat",i+1);
            call_out("givehat",3,me);
            break;
          case 6:
            ...
            plate->move(obj);
            command("give hat to "+ me->query("id") );
