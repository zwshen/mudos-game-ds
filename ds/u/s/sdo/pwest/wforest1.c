...
int out_here1(object me);

void create()
{
	set("short", "迷霧森林內");
	set("long", @LONG
這裡就是迷霧森林內了。你看了看四周，都是高聳入天的樹木，
發現實在不知道該往哪裡走，而且樹林內籠罩著薄薄的白霧，讓你更
是難以分辨方向。
LONG
	);
	set("no_clean_up", 0);
	...
	set("exits", ([ /* sizeof() == 5 */
  		"out" : __DIR__"burg9",
  		"east" : __DIR__"wforest2",
  		"west" : __DIR__"wforest3",
  		"south" : __DIR__"wforest4",
  		"north" : __DIR__"wforest5",
	]));
	set("outdoors","forest");
