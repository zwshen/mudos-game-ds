...
void create()
{
  set("short", HIC"[Magic-Card 專賣店] "HIB"星"HIW"空"HIG"彩"HIR"繪"NOR);
  set ("long", @LONG
...
LONG
  ...
  set("exits", ([
    "up"   : "/open/world2/shengsan/aovandis/room001",
    "down" : __DIR__"room2",
]));
  set("item_desc", ([
  "post" : (: post :),
  ...
  set("light",1);
  setup();
  call_other("/obj/board/magic-card_b2" , "???");
}

string post()
{
  string msg = read_file(__DIR__"post");
  if(!msg) return HIC"無任何公告\n"NOR;
  return msg;
}
