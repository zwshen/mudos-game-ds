...
//=========================°ò¥»³]©w==========================
        ...
        set("long", "¤@­ÓÀ¹µÛ²´Ãèªº¤¤¦~¤H¡M¥¿¦b³o¸ÌÂ\\Åu¦ì½æ±m¨÷¡C\n\n"
        	    +"  ¬Ý¦s³f½Ð¥Î <list> \n"
        	    +"  ­n¶RªF¦è¥Î <buy ½s¸¹ ticket> <buy ª««~> <buy ¼Æ¶q ª««~> \n"
        	    +"  ­n¹ï¼ú¥Î <reward> \n\n"
        );
        set("level",20);
...
//        set("env/wimpy", 20);		//°k¶]wimpy (20%)
   ...
   set("talk_reply","¦h¶RÂI±m¨÷§a..¨þ¨þ..");
	//ª`·N. ­n³]©w³f«~²M³æ
   set("sell_list",([	
           TICKET    : 10, //ªí¥Ü¨C¶R¤@±i±m¨÷·|¦©10ÂI¸Éµ¹ÂI¼Æ
  ...
  set("chat_msg", ({       //°Ê§@¤º®e
"©Ô¿p¥¾¯º¯ºªº»¡: ¤j¦ÑÁó, ­n¤£­n¶RÂI±m¨÷<buy>°Ú? §Ú½æªº±m¨÷<list>¤¤¼ú²v«Ü°ª³á!\n",
(:command("grin"):),
(:command("think"):),
}) );
