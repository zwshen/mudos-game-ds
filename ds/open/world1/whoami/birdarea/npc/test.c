...
void givebag()
{
      ...
      switch( i ) {
          ...
          case 6:
            ...
            obj->call_out("cangive",300,this_object()); 
...
void cangive(object tob)
{ 
       delete_temp("can_not_give");       set("long","他是獵狐村的村長，雖然他的臉上已經佈滿歲月的痕跡了，但是\n"
                  "他那孔武有力的身軀，卻一點都沒有像是老人的樣子。他看來似\n"
                  "乎有點煩惱‧\n"); 
       set("chat_msg", ({ YEL"陳寶低聲的自言自語:怎麼辦...到底該怎麼辦....\n"NOR,
                       (:command("sigh"):),
...
int do_list(string arg)
{
  ...
  object awardeq;
  int i,a,awardcost;
  dir = "/u/w/whoami/area/area/birdarea/npc/change/";
  i = sizeof(file);
  list = "\n\n┌───────────────────────────┐\n";
...
int do_change(string arg)
{
  ...
  if( me->query("quest/ko_fox") < awardcost )
    return notify_fail("陳寶說道: 抱歉! 您砍下的狐狸頭不夠!\n");
