...
void create()
{
	...
	set("inquiry", ([
  "謝基" : "就是那個兔崽子! 誰敢當面跟他說"+HIG+"韃靼舟"+NOR+", "+CYN+"保證龜兒子連屁也放不出一個!\n"NOR,
  "韃靼舟" : "就是這艘船的舟號啦! 要不是海政司那批吃白飯的, 怎會連一張"+HIG+"簽出條"+NOR+"也發不出來?.\n"NOR,
  "簽出條" : "那也是海政司那批人發出來的鬼東西! 偏偏又不發給咱們, 根本是純心找喳....\n",
]));
...
void get_paper()
{
      ...
      switch( i ) {
		...
		p=new(PAST"obj/blood_horse");
        	p->move(environment(this_object()));
