...
void open_war2(object me,object ob)
{
       ...
       message("world:world1:vision",
        ...
        g=new(__DIR__"npc/chini.c");
  g->move("/open/world1/faceoff/sky/ten9.c");
	this_object()->delete("mask");
	this_object()->delete("leg");
	this_object()->delete("glove");
	// add and fix 連續開War bug by alickyuen@ds
        return;
}
