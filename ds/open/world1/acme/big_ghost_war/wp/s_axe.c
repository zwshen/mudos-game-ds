...
void create()
{
    switch( random(100) ) {
        case 0..10:
            set_name(CYN"陰息斧"NOR,({ "in sea axe" ,"axe" }) );
            set("long", "整把斧四周散發著一股黑氣，存著相當多的怨靈，恐怕不是把好斧。");
            set_weight(7000);
            ...
            break;
        case 11..30:
            set_name(CYN"絲纏斧"NOR,({ "se sun axe" ,"axe" }) );
            set("long", "一把以絲纏繞於斧柄的斧，能讓敵人陷於混亂。");
            set_weight(5000);
            ...
            break;
        case 31..50:
            set_name(CYN"青眼斧"NOR,({ "green eye axe" ,"axe" }) );
            set("long", "斧身上有一隻青眼，青眼不時左右轉動著，似乎有靈性一般。");
            set_weight(5000);
            set("value", random(4000)+2000);
            set("volume",3);
            ...
            break;
        case 51..70:
            set_name(CYN"鬼角斧"NOR,({ "ghost axe" ,"axe" }) );
            set("long", "斧柄是一隻大鬼角，還不停的流著鮮血，似乎斬殺過不少人。");
            set_weight(5000);
            set("value", random(4000)+2000);
            set("volume",3);
            ...
            break;
        default:
            set_name(CYN"亦無斧"NOR,({ "yi wu axe" ,"axe" }) );
            set("long", "一把斧身紅透透的斧，看似嚐過不少鮮血一般。");
            set_weight(7000);
            set("value", random(4000)+4444);
            set("volume",3);
            init_axe(48);
