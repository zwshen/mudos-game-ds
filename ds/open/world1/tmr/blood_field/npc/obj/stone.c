...
#define BOSS "/open/world1/tmr/blood_field/npc/nightbane.c"
#define TREEBREAD "/open/world1/tmr/blood_field/npc/ents3.c"

void create()
{
    set_name(HBK"夜禍烏石"NOR, ({"nightbane stone", "stone", "_NIGHTBANE_STONE_"}));
    if( !clonep() ) {
        set("long", @LONG
