...
void combat_ai() {
                ...
                message_vision(HIC "虎象低吼連連，衝上來了幾步！！\n" NOR, this_object());
...
void create()
{
        set_name(HIC "虎象" NOR,({"tiger elephant","tiger", "elephant","5f_guard"}) );
        set("title",CYN "西方七宿" NOR);
        set("long",@LONG
...
LONG    
        ...
        if(random(10)<8) carry_object(__DIR__"eq/tiger-elephant-necklace")->wear();
        else carry_object(__DIR__"eq/tiger-elephant-necklace2")->wear();
}