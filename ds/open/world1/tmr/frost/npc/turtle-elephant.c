...
void combat_ai() {
                ...
                message_vision(HIC "龜象眼睛發出青光，衝上來了幾步！！\n" NOR, this_object());
...
void create()
{
        set_name(HIC "龜象" NOR,({"turtle elephant","turtle", "elephant","5f_guard"}) );
        set("title",CYN "北方七宿" NOR);
        set("long",@LONG
...
LONG    
        ...
        if(random(10)<8) carry_object(__DIR__"eq/turtle-elephant-leggings")->wear();
        else carry_object(__DIR__"eq/turtle-elephant-leggings2")->wear();
}
