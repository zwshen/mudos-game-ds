...
void combat_ai() {
                ...
                message_vision(HIC "鳥象發出數聲怪叫，衝上來了幾步！！\n" NOR, this_object());
...
void create()
{
        set_name(HIC "鳥象" NOR,({"bird elephant","bird", "elephant","5f_guard"}) );
        set("title",CYN "南方七宿" NOR);
        set("long",@LONG
...
LONG    
        ...
        if(random(10)<8) carry_object(__DIR__"eq/bird-elephant-belt")->wear();
        else carry_object(__DIR__"eq/bird-elephant-belt2")->wear();
}
