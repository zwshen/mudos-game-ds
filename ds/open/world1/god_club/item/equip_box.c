...
void create()
{
        set_name(HIY"防具置物箱"NOR,({ "equip box", "box" }));
        set("unit", "個");
        set("long",@long

　用來保存眾多防具的一個大鐵箱，你可以把珍貴的防具放在箱子
　裡面來保存或者是從箱子中拿出你想裝備的防具。

  放東西:  put [東西] in equip box
  拿東西:  get [東西] from equip box
  打開箱子:  open equip box
  關起箱子:  close equip box
...
long
        ...
        set_max_capacity(400); //2003.4.16  1000->400 by ksj
        setup();
