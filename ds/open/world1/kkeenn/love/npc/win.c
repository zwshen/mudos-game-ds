...
void create()
{
        set_name(HIC"目子迎"NOR,({"mu ju win","win"}));
        set("long" ,
...
"是位可敬的女鞭手。\n");
        ...
        carry_object(__DIR__"obj/pill5");
        add_money("coin",1500);
        }
...
void whip()
{
        ...
        target=query_enemy();
             message_vision(
"$N怒斥一聲，滅神鞭法第八式『"WHT"心灰喪鬼神"NOR"』，身隨鞭轉、鞭隨你移，\n正當你被轉的眼花撩亂之時，$N向你下盤處纏去\n",me);
...
int do_guard(string arg)
{
        ...
        write( name() + "將你攔了下來。\n");
      command("grin");
           say(HIC"目子迎"NOR"說道："HIR"要滅派？先問問我的鞭吧！\n"NOR);
        return 1;
}
