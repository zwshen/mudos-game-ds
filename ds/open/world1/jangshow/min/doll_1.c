...
int special_attack(object me,object target,int hitchance)
{
    ...
    if(random(hitchance*30) > tdex+tcon)
    {
     ...
     target->receive_damage("hp",200+random(350), this_object());
      return 1; 
    }
}  
void die()
{
  ...
  switch( random(100) )
  {
    case  0..50: write("哇～～什麼都沒有耶！\n");
          break;
    case  51..94: write("哇～～差一點點！加油！\n");
          break;
    case  95..99: new(__DIR__"sword")->move(this_object()); 
