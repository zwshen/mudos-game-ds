...
int special_attack(object me,object target,int hitchance)
{
    ...
    if(random(hitchance*30) > tdex+tcon)
    {
     ...
     target->receive_damage("hp",450+random(400), this_object());
      return 1; 
    }
}  
void die()
{
  ...
  switch( random(100) )
  {
    case  0..20: write("哇～～什麼都沒有耶！\n");
          break;
        case 21..70: write("哇～～差一點點！加油！\n");
          break;
    case  71..99: new(__DIR__"sword")->move(this_object()); 
