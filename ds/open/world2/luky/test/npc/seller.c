...
//        set("env/wimpy", 20);		//°k¶]wimpy (20%)
   ...
   set("talk_reply","¦h¶RÂIªF¦è´NºâÀ°¤F¤j¦£Åo..¨þ¨þ..");
	//ª`·N. ­n³]©w³f«~²M³æ
   set("sell_list",([	
           __DIR__"item/bag"    : 25, //ªí¥Ü¨C¶R¤@­Ó³U¤l·|¦©15ÂI¸Éµ¹ÂI¼Æ
           __DIR__"item/dump"   : 10, //°£«D¦³¯S®í²z¥Ñ§_«h¤£¥i³]¬°0 (µL­­¶q¨ÑÀ³)
           __DIR__"item/pill2"   : 10,  
           __DIR__"item/torch"   : 5, 
      ]) );

  set("chat_chance", 3 );  //°Ê§@¾÷²v
  set("chat_msg", ({       //°Ê§@¤º®e
"¤ý¤jµo¯º¯ºªº»¡: ¤j¦ÑÁó, ­n¤£­n¶RÂIªF¦è°Ú? §Ú½æªºªF¦è¬Oªþªñ³Ì«K©yªº³á!\n",
