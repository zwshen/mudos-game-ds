...
void create()
{
	set_name("³Â±Nªí©f",({"mj lady","lady"}));
	set("long",@LONG

¤@­Ó¬üÄRªº¤p©f©f¥¿¹ïµÛ§A·L¯º¡C
	                ...
	                switch(met->money_type())
	        	{
					...
					money = met->query("bank/past");
	        			if(money<(j+3)*BetAmount) {
	        				...
	        				met->add("bank/past",(-BetAmount*(j+3)));
	        			        me->add("bank/past",(BetAmount*(j+3)));
	        			        message_vision("$N«Ü¤£ªA®ðªº±N¿é±¼ªº½ä¸êÂà±b¥Iµ¹$n¡C\n",met,me);
	        			     }
	        			break;	
	        		case 2:
					money = met->query("bank/now");
	        			if(money<(j+3)*BetAmount) {
	        				...
	        				met->add("bank/now",(-BetAmount*(j+3)));
	        			        me->add("bank/now",(BetAmount*(j+3)));
	        			        message_vision("$N«Ü¤£ªA®ðªº±N¿é±¼ªº½ä¸êÂà±b¥Iµ¹$n¡C\n",met,me);
	        			     }
	        			break;	
	        		case 3:
					money = met->query("bank/future");
	        			if(money<(j+3)*BetAmount) {
	        				...
	        				met->add("bank/future",(-BetAmount*(j+3)));
	        			        me->add("bank/future",(BetAmount*(j+3)));
	        			        message_vision("$N«Ü¤£ªA®ðªº±N¿é±¼ªº½ä¸êÂà±b¥Iµ¹$n¡C\n",met,me);
	        			     }
	        			break;
	        		default:
	      ...
	      if(BetAmount>0) switch(me->money_type())
	        	{
					...
					money = me->query("bank/past");
        				me->add("bank/past",(-BetAmount*j));
        			        message_vision("$N³Q$n¨S¦¬¤F¤@¨Ç½ä¸ê¡C\n",me,this_object());
	        			break;	
	        		case 2:
