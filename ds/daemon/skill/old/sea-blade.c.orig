...
mapping *action = ({
        ([
        "action": "$N一招"+HIC+"「"+NOR+"靜海雲飛"+HIC+"」"+NOR+"， $w猶如飛雲似殺向$n",
        "damage":                9,
        "dodge" :               10,
        "parry" :               10,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N忽使"+HIC+"「"+NOR+"瀾海漫天"+HIC+"」"+NOR+"，手中$w舞出一片刀網, 劈向$n",
        "damage":                12,
        "dodge":                 -10,
        "parry" :                -6,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N忽轉"+HIC+"「"+NOR+"怒海狂濤"+HIC+"」"+NOR+"，$w挾帶雷霆之勢斬向$n",
        "damage":                13,
        "dodge" :                -5,
        "parry" :               -10,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N清笑一聲"+HIC+"「"+NOR+"漩海疾流"+HIC+"」"+NOR+"，瞬間轉至$n身後, 一刀砍向$n後心",
        "damage":                9,
        "dodge" :                10,
        "parry" :               15,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N青氣陡現"+HIC+"「"+NOR+"暗海潮生"+HIC+"」"+NOR+"，左肱一引一帶，右手$w順勢殺向$n",
        "damage":                10,
        "dodge" :               -20,
        "parry" :                30,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N臉色一沉"+HIC+"「"+NOR+"殤海絕情"+HIC+"」"+NOR+"，$w毫不留後路往$n疾刺而去",
        "damage":                10,
        "dodge" :               -10,
        "parry" :                15,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N身形飄逸,"+HIC+"「"+NOR+"碧海龍升"+HIC+"」"+NOR+"，身行有如巨龍一般躍起, $w瞬息劈向$n",
        "damage":                11,
        "dodge" :                20,
        "parry" :               -10,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N招式一變"+HIC+"「"+NOR+"苦海無疆"+HIC+"」"+NOR+"手中$w猛揮，招式大開大闔, 多股刀氣刺向$n",
        "damage":                14,
        "dodge" :                10,
        "parry" :                15,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N臉色一苦"+HIC+"「"+NOR+"情海陡變"+HIC+"」"+NOR+"，$w竟傳出悲慟之聲, 如有靈性般衝向$n",
        "damage":                14,
        "dodge" :               -15,
        "parry" :                11,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N輕鬆怡然"+HIC+"「"+NOR+"漫海逸流"+HIC+"」"+NOR+"，手中$w亦有閒逸之色, 緩緩殺向$n的$l",
        "damage":                10,
        "dodge" :                10,
        "parry" :                10,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N大喝一聲"+HIC+"「"+NOR+"滄海桑田"+HIC+"」"+NOR+"，$w疾殺向$n之$l的各處大穴，勢如破竹",
        "damage":                13,
        "dodge" :                20,
        "parry" :                30,
        "attact_type":  "bar",
        ...
        ([
        "action": "$N臉色淒苦"+HIC+"「"+NOR+"情海色變"+HIC+"」"+NOR+"氣沉山河，$w同時緩緩斬向$n的$l ",
        "damage":                13,
        "dodge" :               -25,
        "parry" :               -25,
        "attact_type":  "bar",
...
void superpower(object me,object target,int z,int damage)
{
       ...
       msg +=HIW"$N將敵人內勁一引一帶, 盡收於刃中, 反震之勢已勢不可收,!!\n"NOR;
       msg +=HIW"$N再喝一聲, 「海納千川」, 手中之刀盡將$n之攻勢反彈而回!!\n"NOR;
       message_vision(msg, me, target);

       if( z > random(target->query_skill("dodge")) )
       {
       damage = me->query_skill("sea-blade")+random(me->query("str")) +random(target->query("str"))+random(target->query("con"))-target->query_armor() - random(target->query_armor()/3);
