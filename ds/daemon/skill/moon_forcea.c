              ...
              if( arg=="off" )
          {
              ...
              if( !arg )
              {
                  return notify_fail(@SKILL_HELP
                         ...
                         me->skill_active("moon_force", (: call_other, __FILE__, "longarc", me, tar :), random(1));
                                         ...
                                         if( arg == "shadow" ) // wind adv 新增: 殘影訣
                                     {
                                         if( me->query("level") < 30 )
                                             ...
                                             //		me->add_temp("apply/sk_armor", ( ar2=(int)(sk/5 + random(sk/40)) ) ); // 不要加 armor point by linjack
                         ...
                         call_out((: call_other,__FILE__,"moon_shadow",me,ar1,ar2 :), 200+random(30));
                                             return 1;
                                         }
                                 ...
                                 void moon_shadow(object me, int ar1, int ar2)
                                 {
                                     ...
                                     /*	if( me->query_temp("apply/sk_armor") <= ar2 )
                                     		me->set_temp("apply/sk_armor", 0);
                                     	else me->add_temp("apply/sk_armor", -ar2);*/
